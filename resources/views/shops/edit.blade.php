                ...
                <div class="card-body">
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="ssm_no" class="form-control" value="{{ $shop->ssm_no}}">
                        </div>
                        <div class="form-group">
                            <label for="phone">{{ __('Phone')}} </label>
                            <input type="number" name="phone" class="form-control" value="{{ $shop->phone}}">
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-warning mt-3">{{ __('Update Shop')}}</button>
